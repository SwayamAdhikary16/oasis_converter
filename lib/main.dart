  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            centerTitle: true,
            backgroundColor: Color(0xff5882E3).withOpacity(0.63),
...
class _HomeScreenState extends State<HomeScreen> {
  final TextStyle labelStyle = TextStyle(fontSize: 16.0, color: Colors.white);
  ...
  Widget build(BuildContext context) {
    return Container(
      color: Color(0xff1F253B).withOpacity(0.2),
      child: Padding(
